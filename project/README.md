...
``` conf
POSTGRES_USER=user
POSTGRES_PASSWORD=<key to exchange with device-management, identity-management, data-processor, data-decoder and smart-irrigation backends>
```
...
File. `project/secrets/prod/sharespot-smart-irrigation-backend.env`
