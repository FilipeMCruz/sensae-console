...
import pt.sensae.services.device.management.master.backend.application.DeviceInformationRegisterService;
...
public class DeviceInformationRegisterController {
    ...
    private final DeviceInformationRegisterService service;

    public DeviceInformationRegisterController(DeviceInformationRegisterService service) {
