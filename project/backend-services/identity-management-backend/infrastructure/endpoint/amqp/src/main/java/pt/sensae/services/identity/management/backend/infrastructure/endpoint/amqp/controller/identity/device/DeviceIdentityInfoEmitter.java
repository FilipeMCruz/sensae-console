...
import pt.sensae.services.identity.management.backend.application.internal.identity.device.DeviceIdentityEventHandlerService;
...
public class DeviceIdentityInfoEmitter {
    ...
    private final DeviceIdentityEventHandlerService service;

    private final InternalRoutingKeys info;

    public DeviceIdentityInfoEmitter(@Qualifier("amqpTemplate") AmqpTemplate template, DeviceIdentityEventHandlerService service, RoutingKeysProvider provider) {
