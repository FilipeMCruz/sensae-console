package pt.sensae.services.notification.management.backend.infrastructure.containers;

import org.testcontainers.containers.PostgreSQLContainer;
import org.testcontainers.utility.DockerImageName;

public class DatabaseContainerTest extends PostgreSQLContainer<DatabaseContainerTest> {
    private static final String IMAGE_VERSION = "notification-management-database";
