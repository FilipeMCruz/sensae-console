package pt.sensae.services.rule.management.backend.infrastructure.persistence.postgres;

import org.springframework.stereotype.Repository;
import org.springframework.transaction.annotation.Transactional;
import pt.sensae.services.rule.management.backend.domain.RuleScenarioOwners;
import pt.sensae.services.rule.management.backend.infrastructure.persistence.postgres.mapper.RuleScenarioMapper;
...
import pt.sensae.services.rule.management.backend.infrastructure.persistence.postgres.repository.RuleScenarioRepositoryPostgres;
import pt.sensae.services.rule.management.backend.infrastructure.persistence.postgres.repository.util.PostgresArrayMapper;
