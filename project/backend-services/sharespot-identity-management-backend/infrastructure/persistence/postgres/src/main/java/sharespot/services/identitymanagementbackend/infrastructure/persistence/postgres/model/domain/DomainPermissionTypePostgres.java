...
public class DomainPermissionTypePostgres {
    ...
    public static DomainPermissionTypePostgres create(PermissionType type) {
        return switch (type) {
            ...
            case CREATE_DEVICE_RECORD -> new DomainPermissionTypePostgres(14);
            ...
            case CREATE_DATA_TRANSFORMATION -> new DomainPermissionTypePostgres(16);
            ...
            case CREATE_DATA_DECODER -> new DomainPermissionTypePostgres(18);
            ...
            case CREATE_DOMAIN -> new DomainPermissionTypePostgres(28);
        };
    }
    ...
    public static PermissionType from(DomainPermissionTypePostgres postgres) {
        return switch (postgres.type) {
            ...
            case 14 -> PermissionType.CREATE_DEVICE_RECORD;
            case 15 -> PermissionType.DELETE_DEVICE_RECORD;
            case 16 -> PermissionType.CREATE_DATA_TRANSFORMATION;
            case 17 -> PermissionType.DELETE_DATA_TRANSFORMATION;
            case 18 -> PermissionType.CREATE_DATA_DECODER;
            ...
            case 28 -> PermissionType.CREATE_DOMAIN;
