...
import pt.sensae.services.smart.irrigation.backend.domain.model.business.irrigationZone.Area;
import pt.sensae.services.smart.irrigation.backend.domain.model.business.irrigationZone.BoundaryPoint;
...
public class AreaBoundariesMapper {
    ...
    public static Stream<AreaBoundariesPostgres> modelToDao(Area area, IrrigationZoneId areaId) {
