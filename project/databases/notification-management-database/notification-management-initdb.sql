...
ALTER TABLE public.read OWNER TO "user";

ALTER TABLE public.read ALTER COLUMN persistence_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.read_persistence_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
SELECT pg_catalog.setval('public.read_persistence_id_seq', 1, false);

ALTER TABLE ONLY public.read
    ADD CONSTRAINT read_pkey PRIMARY KEY (persistence_id);
