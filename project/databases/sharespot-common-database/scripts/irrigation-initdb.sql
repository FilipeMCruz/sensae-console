...
SELECT pg_catalog.setval('public.boundary_persistence_id_seq', 1, true);

ALTER TABLE ONLY public.gardening_area_boundary
    ADD CONSTRAINT gardening_area_boundary_pkey PRIMARY KEY (persistence_id);
