...
module.exports = {
  output: {
    uniqueName: 'notification-management-frontend',
    publicPath: 'auto',
  },
  optimization: {
    runtimeChunk: false,
  ...
  plugins: [
    new ModuleFederationPlugin({
      name: 'notificationmanagementfrontend',
      filename: 'remoteEntry.js',
      exposes: {
        './Module':
          'apps/notification-management-frontend/src/app/remote-entry/entry.module.ts',
      },
      shared: share({
        '@angular/animations': {
          singleton: true,
