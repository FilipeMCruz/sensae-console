...
export class QueryMapper {
  ...
  static toCreateDomain(parentId: string, domainName: string): CreateDomainQueryDTO {
  ...
  static toRemoveTenant(tenantId: string, domainId: string): RemoveTenantQueryDTO {
    return {instructions: {tenantOid: tenantId, domainOid: domainId}};
  }

  static toAddDevice(deviceId: string, domainId: string, write: boolean): AddDeviceQueryDTO {
    return {instructions: {deviceOid: deviceId, domainOid: domainId, writePermission: write}};
  }

  static toRemoveDevice(deviceId: string, domainId: string): RemoveDeviceQueryDTO {
